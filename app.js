...
let webDevCollection = [
    { id: 1, question: "What is a block-level element?", answer: "A block-level element in HTML starts on a new line and takes up the full width available. Example: <div>, <p>, and <h1> are block-level elements." },
    { id: 2, question: "What is the difference between HTML, CSS, and JavaScript?", answer: "HTML provides the structure of a webpage, CSS controls the appearance (styles), and JavaScript enables interactive behavior on the page." },
    { id: 3, question: "What is the most recent JavaScript concept or framework you've taught yourself?", answer: "This is a subjective question. Example: 'Recently, I taught myself React, which helps build reusable components in front-end applications.'" },
    { id: 4, question: "What happens when a browser requests a web page?", answer: "The browser sends an HTTP request to the server, which processes the request and sends back an HTTP response containing the HTML, CSS, and JavaScript files to display the webpage." }];
